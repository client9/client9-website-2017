...
# but downloading directly rom GitHub releases takes 0.3 seconds.
#
# 2. make sure your version is the same as travis.ci
...
# or set the version on the command line 
# as the first arg.
#
# ./download-hugo.sh 0.20.0
#
VERSION=${1:-$HUGO_LATEST}
